...
def addRhoInfo(branch):
    tool = branch.addTupleTool("LoKi::Hybrid::TupleTool/Loki_rho")
    tool.Variables = {
        "PID": "ID",
        "M": "M",
        "MM":"MM",
...
def addPionInfo(branch):
    tool = branch.addTupleTool("LoKi::Hybrid::TupleTool/Loki_pi")
    tool.Variables = {
        "PID": "ID",
        "M": "M",
        "MM":"MM",
